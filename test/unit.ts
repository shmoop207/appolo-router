...
describe("Router", () => {
    ...
    it("Should find static route ", () => {
        ...
        let output = router.find("GET" as Methods, "/test/test2/test3/");
        output.handler.working2.should.be.ok;


        output = router.find("GET" as Methods, "/test/test2/");
        ...
        output = router.find("GET" as Methods, "/test/test2/test3/test4/test5/");
        should.not.exist(output);

        output = router.find("GET" as Methods, "/test/test2/test3/test5/");
        should.not.exist(output);
    });
    ...
    it("Should find param route ", () => {
        ...
        output = router.find("GET" as Methods, "/test/test2/test3/");
        output.handler.working2.should.be.ok;
    ...
    it("Should find regex route ", () => {
        ...
        let output = router.find("GET" as Methods, "/test/123/");

        output.handler.working1.should.be.ok;
        output.params.foo.should.be.eq("123");

        output = router.find("GET" as Methods, "/test/123test/");
    ...
    it("Should find regex route with param ", () => {
        ...
        let output = router.find("GET" as Methods, "/test/123test/bbb/ccc");
    ...
    it("Should find regex route with param and wildcard", () => {
        ...
        let output = router.find("GET" as Methods, "/test/123test/nnn");

        output.handler.working2.should.be.ok;
        output.params.foo.should.be.eq("123test/nnn");

        output = router.find("GET" as Methods, "/test/123test/bbb/cccc");
    ...
    it("Should find with regex route with wildcard ", () => {
        ...
        output = router.find("GET" as Methods, "/test");
        output.handler.working2.should.be.ok;

        output = router.find("GET" as Methods, "/tes/");
        should.not.exist(output);

        output = router.find("GET" as Methods, "/test/123test/nnn");
        output.handler.working2.should.be.ok;

        output = router.find("GET" as Methods, "/test/123test/test2/");
        output.handler.working3.should.be.ok;
        output.params.foo.should.be.eq("123test");

        output = router.find("GET" as Methods, "/test/123test/test3/");
        output.handler.working2.should.be.ok;

        output = router.find("GET" as Methods, "/test/123test/test3/test4");
        output.handler.working2.should.be.ok;

        output = router.find("GET" as Methods, "/test/aaa/bbb/ccc/test5");
        output.handler.working4.should.be.ok;
    ...
    it("Should run benchmarks tests", () => {
        ...
        routes.forEach((route, index) => {
            router.add(route.method as any, route.url, {name: index})
        });
